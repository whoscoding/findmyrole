...
describe('ButtonOneComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(ButtonOneComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(ButtonOneComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('ButtonOneView')
    })
