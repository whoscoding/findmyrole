...
def _validate_delegate_access_token(delegate_access_token):
  ...
  # )
  url = "https://niblscoin.b2clogin.com/niblscoin.onmicrosoft.com/{}/v2.0/token".format(CONFIGS.azure_auth["signupsignin_user_flow"])
  resp = requests.get(
        url,
...
def update_user_profile():
  ...
  app_access_token = _get_azure_application_access_token()
