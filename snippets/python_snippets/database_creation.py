...
connstring = "mssql+pyodbc://sa:wX.D}/n(ZNpzVr}@localhost:1433/nibls-mssql-database-0?driver=ODBC+Driver+17+for+SQL+Server"
sqlalchemy_0_engine = ""
sqlalchemy_0_conn = ""
def set_up_sql_conn():
...
rows = []
def add_rows_to_niblsballevents():
  for  i in range(20):
...
def insert_rows_into_niblsballevents():
  for row in rows:
...
add_rows_to_niblsballevents()
insert_rows_into_niblsballevents()
